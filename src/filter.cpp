...
void Frontier_Navigation::check(std::vector<geometry_msgs::Point> test) {
    vec_single transfer;
...
void Frontier_Navigation::preFilterMap_fi(int radius) {
...
void Frontier_Navigation::preFilterMap_FII(const geometry_msgs::PoseStamped &center, int radius) {
...
void Frontier_Navigation::preFilterMap(const geometry_msgs::PoseStamped &center, int radius) {
